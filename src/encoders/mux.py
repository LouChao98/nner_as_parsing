...
class MuxEncoder(EncoderBase):
    ...
    def forward(self, x, vp: VarPool):
        ...
        for source_name in self.all_encoders:
            encoder_out = getattr(self, source_name)(x, vp)
    ...
    def set_trainer(self, trainer: Trainer):
        for encoder_name in self.all_encoders:
            getattr(self, encoder_name).set_trainer(trainer)
